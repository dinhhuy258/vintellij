...
function M.setup(cfg)
	...
	vim.api.nvim_command([[command! VintellijOptimizeImport lua require("vintellij.commands.import").optimize_import()]])
	vim.api.nvim_command([[command! VintellijGenDoc lua require("vintellij.commands.doc").gen_doc()]])
